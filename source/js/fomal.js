...
$.ajax({
  ...
  data: {
    key: "VCPBZ-QCCRJ-KEKFJ-F632K-NB23H-K4BKU", // 这里要写你的KEY!!!
    output: "jsonp",
  },
  dataType: "jsonp",
...
function createtime() {
  ...
  let currentTimeHtml = "";
  {
    /* <img class='boardsign' src='https://lskypro.acozycotage.net/Fomalhaut/badge/F小屋-科研摸鱼中.svg' title='什么时候能够实现财富自由呀~'><br></br>
<img class='boardsign' src='https://lskypro.acozycotage.net/Fomalhaut/badge/F小屋-下班休息啦.svg' title='下班了就该开开心心地玩耍~'><br></br> */
  }
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    ...
    --darkmode-bg:url(https://static.panrui.top/images/blog/pc_night_bg.jpg);
